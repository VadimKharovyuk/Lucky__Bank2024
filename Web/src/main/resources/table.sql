...
-- Вставка данных в таблицу job_position
INSERT INTO job_position (position) VALUES
...
-- Вставка данных в таблицу job_application_skills (для связи с job_application)
INSERT INTO job_application_skills (job_application_id, skills) VALUES
                                                                   (1, 'Java'),
                                                                   (1, 'Spring Boot'),
                                                                   (1, 'REST API'),
                                                                   (2, 'Python'),
